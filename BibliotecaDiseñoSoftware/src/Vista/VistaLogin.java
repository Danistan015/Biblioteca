...
public class VistaLogin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jSeparator1.setBackground(new java.awt.Color(147, 177, 166));
        jSeparator1.setFont(new java.awt.Font("Poppins SemiBold", 1, 14)); // NOI18N

        txtUsuario.setBackground(new java.awt.Color(4, 13, 18));
        txtUsuario.setFont(new java.awt.Font("Poppins Medium", 0, 14)); // NOI18N
        txtUsuario.setForeground(new java.awt.Color(147, 177, 166));
